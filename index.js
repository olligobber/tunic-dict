(() => {
      ...
      append: function(v2) {
        return function(v1) {
          ...
          if (v2 instanceof Just && v1 instanceof Just) {
            return new Just(append16(v2.value0)(v1.value0));
          }
          ;
  ...
  var stepAsc = /* @__PURE__ */ function() {
    return stepAscCps(function(k, v2, next) {
      return new IterNext(k, v2, next);
            ...
            return function($copy_b) {
              ...
              function $tco_loop(a3, b2) {
                ...
                if (v2 instanceof IterNext) {
                  var v22 = stepAsc(b2);
                  if (v22 instanceof IterNext && (eq14(v2.value0)(v22.value0) && eq23(v2.value1)(v22.value1))) {
                    $tco_var_a = v2.value2;
                    $copy_b = v22.value2;
                    return;
                  }
    ...
    foldMap: function(dictMonoid) {
      ...
      return function(f) {
        var go2 = function(v2) {
          ...
          ;
          if (v2 instanceof Node) {
            return append16(go2(v2.value4))(append16(f(v2.value3))(go2(v2.value5)));
          }
          ;
    ...
    foldMapWithIndex: function(dictMonoid) {
      ...
      return function(f) {
        var go2 = function(v2) {
          ...
          ;
          if (v2 instanceof Node) {
            return append16(go2(v2.value4))(append16(f(v2.value2)(v2.value3))(go2(v2.value5)));
          }
          ;
  ...
  var alter = function(dictOrd) {
    ...
    return function(f) {
      return function(k) {
        return function(m2) {
          var v2 = unsafeSplit(compare6, k, m2);
          var v22 = f(v2.value0);
          if (v22 instanceof Nothing) {
  ...
  var cons = function(dictOrd) {
    return coerce4(insert2(dictOrd));
  };
  ...
  var runGraft = /* @__PURE__ */ unGraft(function(v2) {
    var go2 = function(v22) {
      ...
      if (v22 instanceof Elem) {
        return new Elem(v22.value0, v22.value1, v2.value0(v22.value2), map5(go2)(v22.value3));
      }
      ;
      if (v22 instanceof Keyed) {
        return new Keyed(v22.value0, v22.value1, v2.value0(v22.value2), map5(map1(go2))(v22.value3));
      }
      ;
  ...
  var viewBox = function(x_) {
    return function(y_) {
      return function(w) {
        return function(h_) {
          return attr2("viewBox")(joinWith(" ")(map7(show3)([x_, y_, w, h_])));
        };
      };
    };
  };
  ...
  var compare12 = /* @__PURE__ */ compare(/* @__PURE__ */ ordArray(ordNumber));
  var append2 = /* @__PURE__ */ append(semigroupArray);
  var Point2D = /* @__PURE__ */ function() {
    function Point2D2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    Point2D2.create = function(value0) {
      return function(value1) {
        return new Point2D2(value0, value1);
      };
    };
    return Point2D2;
  }();
  var Drawing = /* @__PURE__ */ function() {
    function Drawing2(value0) {
      this.value0 = value0;
    }
    ;
    Drawing2.create = function(value0) {
      return new Drawing2(value0);
    };
    return Drawing2;
  }();
  var withoutViewport = function(v2) {
    return new Drawing({
  ...
  var append12 = /* @__PURE__ */ append(semigroupVertical);
  ...
  var append22 = /* @__PURE__ */ append(semigroupHorizontal);
  var semigroupPoint2D = {
    append: function(v2) {
      return function(v1) {
        return new Point2D(append22(v2.value0)(v1.value0), append12(v2.value1)(v1.value1));
      };
    }
  };
  var append3 = /* @__PURE__ */ append(semigroupPoint2D);
  var withOffset = function(p2) {
    return function(offset) {
      return append3(p2)(offset);
    };
  };
  var monoidVertical = {
    mempty: 0,
  ...
  var monoidHorizontal = {
    mempty: 0,
    Semigroup0: function() {
      return semigroupHorizontal;
    }
  };
  var monoidPoint2D = /* @__PURE__ */ function() {
    return {
      mempty: new Point2D(mempty(monoidHorizontal), mempty(monoidVertical)),
      Semigroup0: function() {
        return semigroupPoint2D;
      }
    };
  }();
  var gsubtract = function(dictGroup) {
    var append82 = append(dictGroup.Monoid0().Semigroup0());
    var ginverse2 = ginverse(dictGroup);
    return function(a3) {
      return function(b2) {
        return append82(a3)(ginverse2(b2));
      };
    };
  };
  var groupVertical = {
    ...
    Monoid0: function() {
      return monoidVertical;
    }
  };
  var gsubtract1 = /* @__PURE__ */ gsubtract(groupVertical);
  var groupHorizontal = {
    ginverse: function(v2) {
      return -v2;
    },
    Monoid0: function() {
      return monoidHorizontal;
    }
  };
  var gsubtract2 = /* @__PURE__ */ gsubtract(groupHorizontal);
  var group2 = function(v2) {
    return function(v1) {
      return new Drawing({
        minX: v1.value0.minX,
        maxX: v1.value0.maxX,
        minY: v1.value0.minY,
        maxY: v1.value0.maxY,
        elements: [g2(v2)(v1.value0.elements)]
      });
    };
  };
  var fromVertical = function(v2) {
    return v2;
  };
  var fromHorizontal = function(v2) {
    return v2;
  };
  var eqVertical = {
    eq: function(x) {
  ...
  var min3 = /* @__PURE__ */ min(ordVertical);
  var max3 = /* @__PURE__ */ max(ordVertical);
  var append4 = /* @__PURE__ */ append(/* @__PURE__ */ semigroupMaybe(/* @__PURE__ */ semigroupMin(ordVertical)));
  var append5 = /* @__PURE__ */ append(/* @__PURE__ */ semigroupMaybe(/* @__PURE__ */ semigroupMax(ordVertical)));
  var eqPoint2D = {
    eq: function(v2) {
      return function(v1) {
  ...
  var ordPoint2D = {
    compare: function(v2) {
      return function(v1) {
        return compare12([v2.value0, v2.value1])([v1.value0, v1.value1]);
      };
    },
    Eq0: function() {
      return eqPoint2D;
  ...
  var min1 = /* @__PURE__ */ min(ordHorizontal);
  var max1 = /* @__PURE__ */ max(ordHorizontal);
  var append6 = /* @__PURE__ */ append(/* @__PURE__ */ semigroupMaybe(/* @__PURE__ */ semigroupMin(ordHorizontal)));
  var append7 = /* @__PURE__ */ append(/* @__PURE__ */ semigroupMaybe(/* @__PURE__ */ semigroupMax(ordHorizontal)));
  var line3 = function(v2) {
    return function(v1) {
      return function(color) {
        return function(v22) {
          return new Drawing({
            elements: [line2(append2([x1(fromHorizontal(v2.value0)), x2(fromHorizontal(v1.value0)), y1(fromVertical(v2.value1)), y2(fromVertical(v1.value1)), stroke(color), strokeWidth(1), strokeLineCap(LineCapRound.value)])(v22))],
            minX: new Just(gsubtract2(min1(v2.value0)(v1.value0))(1)),
            maxX: new Just(append22(max1(v2.value0)(v1.value0))(1)),
            minY: new Just(gsubtract1(min3(v2.value1)(v1.value1))(1)),
            maxY: new Just(append12(max3(v2.value1)(v1.value1))(1))
          });
        };
      };
    };
  };
  var renderDrawing = function(v2) {
    return function(attrs) {
      var minY = function() {
        if (v2.value0.minY instanceof Nothing) {
          return 0;
        }
        ;
        if (v2.value0.minY instanceof Just) {
          return v2.value0.minY.value0;
        }
        ;
        throw new Error("Failed pattern match at Drawing (line 208, column 10 - line 210, column 33): " + [v2.value0.minY.constructor.name]);
      }();
      var minX = function() {
        if (v2.value0.minX instanceof Nothing) {
          return 0;
        }
        ;
        if (v2.value0.minX instanceof Just) {
          return v2.value0.minX.value0;
        }
        ;
        throw new Error("Failed pattern match at Drawing (line 205, column 10 - line 207, column 35): " + [v2.value0.minX.constructor.name]);
      }();
      var difference4 = function(dictGroup) {
        var mempty5 = mempty(dictGroup.Monoid0());
        var gsubtract3 = gsubtract(dictGroup);
        return function(dictOrd) {
          var max22 = max(dictOrd);
          return function(v1) {
            if (v1.min instanceof Just && v1.max instanceof Just) {
              return max22(mempty5)(gsubtract3(v1.max.value0)(v1.min.value0));
            }
            ;
            return mempty5;
          };
      ...
      var height9 = fromVertical(difference4(groupVertical)(ordVertical)({
        min: v2.value0.minY,
        max: v2.value0.maxY
      }));
      var width8 = fromHorizontal(difference4(groupHorizontal)(ordHorizontal)({
        min: v2.value0.minX,
        max: v2.value0.maxX
      }));
      return svg(append2([viewBox(minX)(minY)(width8)(height9)])(attrs))(v2.value0.elements);
    };
  };
  var semigroupDrawing = {
    append: function(v2) {
      return function(v1) {
        return new Drawing({
          elements: append2(v2.value0.elements)(v1.value0.elements),
          minX: append6(v2.value0.minX)(v1.value0.minX),
          maxX: append7(v2.value0.maxX)(v1.value0.maxX),
          minY: append4(v2.value0.minY)(v1.value0.minY),
          maxY: append5(v2.value0.maxY)(v1.value0.maxY)
        });
      };
    }
  };
  ...
  var circle3 = function(v2) {
    return function(radius) {
      return function(stroke2) {
        return function(fill2) {
          return function(v1) {
            var fullRadius = radius + 1;
            return new Drawing({
              elements: [circle2(append2([cx(fromHorizontal(v2.value0)), cy(fromVertical(v2.value1)), r(radius), stroke(stroke2), strokeWidth(1), fill(fill2)])(v1))],
              minX: new Just(gsubtract2(v2.value0)(fullRadius)),
              maxX: new Just(append22(v2.value0)(fullRadius)),
              minY: new Just(gsubtract1(v2.value1)(fullRadius)),
              maxY: new Just(append12(v2.value1)(fullRadius))
            });
          };
        };
      };
  ...
  var snoc3 = function(cat) {
    return function(a3) {
      return append8(cat)(new CatCons(a3, empty6));
    };
  };
  ...
  var toView = function($copy_v) {
    ...
    function $tco_loop(v2) {
      ...
      var concatF = function(v23) {
        return function(r2) {
          return new Free(v23.value0, append9(v23.value1)(r2));
        };
      };
                ...
                return bind12(liftEffect4(read(ref2)))(function(v22) {
                  return bind12(liftEffect4($$new(false)))(function(doneRef) {
                    return bind12(fork3($$finally(liftEffect4(function __do2() {
                      modify_2($$delete3(fid))(v22.forks)();
  ...
  var onMouseOut = /* @__PURE__ */ function() {
    var $35 = handler2(mouseout);
    return function($36) {
      return $35(mouseHandler($36));
    };
  }();

  // output/Tunic.Glyph/index.js
  ...
  var UpRight = /* @__PURE__ */ function() {
    ...
    ;
    UpRight2.value = new UpRight2();
    return UpRight2;
  }();
  var DownRight = /* @__PURE__ */ function() {
    function DownRight2() {
    }
    ;
    DownRight2.value = new DownRight2();
    return DownRight2;
  }();
  ...
  var DownLeft = /* @__PURE__ */ function() {
    function DownLeft2() {
    }
    ;
    DownLeft2.value = new DownLeft2();
    return DownLeft2;
  }();
  var UpLeft = /* @__PURE__ */ function() {
    function UpLeft2() {
    }
    ;
    UpLeft2.value = new UpLeft2();
    return UpLeft2;
  }();
  var CircSegment = /* @__PURE__ */ function() {
    function CircSegment2() {
    }
    ;
    CircSegment2.value = new CircSegment2();
    return CircSegment2;
  }();
  var Vowel = /* @__PURE__ */ function() {
    function Vowel2(value0) {
      this.value0 = value0;
    }
    ;
    Vowel2.create = function(value0) {
      return new Vowel2(value0);
    };
    return Vowel2;
  }();
  var Consonant = /* @__PURE__ */ function() {
    function Consonant2(value0) {
      this.value0 = value0;
    }
    ;
    Consonant2.create = function(value0) {
      return new Consonant2(value0);
    };
    return Consonant2;
  }();
  var Circ = /* @__PURE__ */ function() {
    function Circ2(value0) {
      this.value0 = value0;
    }
    ;
    Circ2.create = function(value0) {
      return new Circ2(value0);
    };
    return Circ2;
  }();
  var eqVowelSegment = {
  ...
  var eq2 = /* @__PURE__ */ eq(eqVowelSegment);
  var ordVowelSegment = {
    compare: function(x) {
      return function(y) {
        if (x instanceof TopRight && y instanceof TopRight) {
        ...
        ;
        if (x instanceof Left2) {
          return LT.value;
        }
        ;
        if (y instanceof Left2) {
          return GT.value;
        }
        ;
        if (x instanceof TopLeft && y instanceof TopLeft) {
        ...
        ;
        throw new Error("Failed pattern match at Tunic.Glyph (line 0, column 0 - line 0, column 0): " + [x.constructor.name, y.constructor.name]);
      };
    },
    Eq0: function() {
      return eqVowelSegment;
    }
  };
  var compare4 = /* @__PURE__ */ compare(ordVowelSegment);
  var eqConsonantSegment = {
    eq: function(x) {
      return function(y) {
        ...
        ;
        if (x instanceof DownRight && y instanceof DownRight) {
          return true;
        }
        ;
        ...
        ;
        if (x instanceof DownLeft && y instanceof DownLeft) {
          return true;
        }
        ;
        if (x instanceof UpLeft && y instanceof UpLeft) {
          return true;
        }
        ;
        return false;
  ...
  var eq12 = /* @__PURE__ */ eq(eqConsonantSegment);
  var ordConsonantSegment = {
    compare: function(x) {
      return function(y) {
        if (x instanceof Up && y instanceof Up) {
          return EQ.value;
        ...
        ;
        if (x instanceof DownRight) {
          return LT.value;
        }
        ;
        if (y instanceof DownRight) {
          return GT.value;
        }
        ;
        if (x instanceof Down && y instanceof Down) {
        ...
        ;
        if (x instanceof DownLeft) {
          return LT.value;
        }
        ;
        if (y instanceof DownLeft) {
          return GT.value;
        }
        ;
        if (x instanceof UpLeft && y instanceof UpLeft) {
    ...
    Eq0: function() {
      return eqConsonantSegment;
    }
  };
  var compare13 = /* @__PURE__ */ compare(ordConsonantSegment);
  var eqCircSegment = {
    eq: function(x) {
      return function(y) {
        return true;
  ...
  var eq22 = /* @__PURE__ */ eq(eqCircSegment);
  var eqSegment = {
    eq: function(x) {
      return function(y) {
        if (x instanceof Vowel && y instanceof Vowel) {
          return eq2(x.value0)(y.value0);
        }
        ;
        if (x instanceof Consonant && y instanceof Consonant) {
  ...
  var ordCircSegment = {
    ...
    Eq0: function() {
      return eqCircSegment;
    }
  };
  var compare22 = /* @__PURE__ */ compare(ordCircSegment);
  var ordSegment = {
    compare: function(x) {
      return function(y) {
        if (x instanceof Vowel && y instanceof Vowel) {
  ...
  var fullGlyph = /* @__PURE__ */ function() {
    return cons(ordSegment)(new Circ(CircSegment.value))(fromFoldable2(foldableArray)(ordSegment)([new Vowel(TopRight.value), new Vowel(BottomRight.value), new Vowel(BottomLeft.value), new Vowel(Left2.value), new Vowel(TopLeft.value), new Consonant(Up.value), new Consonant(UpRight.value), new Consonant(DownRight.value), new Consonant(Down.value), new Consonant(DownLeft.value), new Consonant(UpLeft.value)]));
  }();

  // output/Tunic.Drawing/index.js
  var monoidFn2 = /* @__PURE__ */ monoidFn(monoidDrawing);
  var mempty2 = /* @__PURE__ */ mempty(monoidFn2);
  var apply2 = /* @__PURE__ */ apply(applyFn);
  var map20 = /* @__PURE__ */ map(functorFn);
  var topFaceY = 4;
  var topCornerY = 0;
  var simpleDrawNoLine = function(color) {
    return {
      drawLine: function(m2) {
        return function(p1) {
          return function(p2) {
            ...
            ;
            if (m2 instanceof Just) {
              return apply2(map20(function(a3) {
                return function(b2) {
                  return line3(a3)(b2)(color)([]);
                };
              })(withOffset(p1)))(withOffset(p2));
            }
            ;
            throw new Error("Failed pattern match at Tunic.Drawing (line 82, column 27 - line 86, column 22): " + [m2.constructor.name]);
          };
        };
      },
      drawCirc: function(v2) {
        return function(p2) {
          return function(r2) {
            return map20(function(a3) {
              return circle3(a3)(r2)(color)(NoColor.value)([]);
            })(withOffset(p2));
          };
        };
      }
  ...
  var simpleDraw = function(color) {
    return {
      drawLine: function(v2) {
        return function(p1) {
          return function(p2) {
            return apply2(map20(function(a3) {
              return function(b2) {
  ...
  var bottomFaceY = 16;
  var bottomCornerY = 20;
  var belowLineY = 12;
  var drawSegment = function(dictSemigroup) {
    var append16 = append(dictSemigroup);
    return function(v2) {
      return function(v1) {
        if (v1 instanceof Vowel && v1.value0 instanceof TopRight) {
          return v2.drawLine(new Just(v1))(new Point2D(middleX, topCornerY))(new Point2D(rightX, topFaceY));
        }
        ;
        if (v1 instanceof Vowel && v1.value0 instanceof BottomRight) {
          return v2.drawLine(new Just(v1))(new Point2D(rightX, bottomFaceY))(new Point2D(middleX, bottomCornerY));
        }
        ;
        if (v1 instanceof Vowel && v1.value0 instanceof BottomLeft) {
          return v2.drawLine(new Just(v1))(new Point2D(middleX, bottomCornerY))(new Point2D(leftX, bottomFaceY));
        }
        ;
        if (v1 instanceof Vowel && v1.value0 instanceof Left2) {
          return append16(v2.drawLine(new Just(v1))(new Point2D(leftX, topFaceY))(new Point2D(leftX, lineY)))(v2.drawLine(new Just(v1))(new Point2D(leftX, belowLineY))(new Point2D(leftX, bottomFaceY)));
        }
        ;
        if (v1 instanceof Vowel && v1.value0 instanceof TopLeft) {
          return v2.drawLine(new Just(v1))(new Point2D(middleX, topCornerY))(new Point2D(leftX, topFaceY));
        }
        ;
        if (v1 instanceof Consonant && v1.value0 instanceof Up) {
          return append16(v2.drawLine(new Just(v1))(new Point2D(middleX, topCornerY))(new Point2D(middleX, frontCornerY)))(v2.drawLine(new Just(v1))(new Point2D(middleX, frontCornerY))(new Point2D(middleX, lineY)));
        }
        ;
        if (v1 instanceof Consonant && v1.value0 instanceof UpRight) {
          return v2.drawLine(new Just(v1))(new Point2D(middleX, frontCornerY))(new Point2D(rightX, topFaceY));
        }
        ;
        if (v1 instanceof Consonant && v1.value0 instanceof DownRight) {
          return v2.drawLine(new Just(v1))(new Point2D(middleX, belowLineY))(new Point2D(rightX, bottomFaceY));
        }
        ;
        if (v1 instanceof Consonant && v1.value0 instanceof Down) {
          return append16(v2.drawLine(new Just(v1))(new Point2D(middleX, frontCornerY))(new Point2D(middleX, lineY)))(v2.drawLine(new Just(v1))(new Point2D(middleX, belowLineY))(new Point2D(middleX, bottomCornerY)));
        }
        ;
        if (v1 instanceof Consonant && v1.value0 instanceof DownLeft) {
          return v2.drawLine(new Just(v1))(new Point2D(middleX, belowLineY))(new Point2D(leftX, bottomFaceY));
        }
        ;
        if (v1 instanceof Consonant && v1.value0 instanceof UpLeft) {
          return v2.drawLine(new Just(v1))(new Point2D(middleX, frontCornerY))(new Point2D(leftX, topFaceY));
        }
        ;
        if (v1 instanceof Circ) {
          return v2.drawCirc(v1)(new Point2D(middleX, circleCenterY))(circleRadius);
        }
        ;
        throw new Error("Failed pattern match at Tunic.Drawing (line 92, column 1 - line 92, column 67): " + [v2.constructor.name, v1.constructor.name]);
      };
    };
  };
  var drawGlyph = function(dictFoldable) {
    var foldMap4 = foldMap(dictFoldable);
    return function(dictMonoid) {
      var Semigroup0 = dictMonoid.Semigroup0();
      var append16 = append(Semigroup0);
      var foldMap12 = foldMap4(dictMonoid);
      var drawSegment1 = drawSegment(Semigroup0);
      return function(drawFunc) {
        return function(glyph) {
          return append16(foldMap12(drawSegment1(drawFunc))(glyph))(drawFunc.drawLine(Nothing.value)(new Point2D(leftX, lineY))(new Point2D(rightX, lineY)));
        };
      };
    };
  };

  // output/Tunic.Clickable/index.js
  var prop3 = /* @__PURE__ */ prop2(isPropString);
  var pure10 = /* @__PURE__ */ pure(applicativeFn);
  var foldMapWithIndex2 = /* @__PURE__ */ foldMapWithIndex(foldableWithIndexMap)(monoidDrawing);
  var mempty3 = /* @__PURE__ */ mempty(monoidDrawing);
  var foldMap3 = /* @__PURE__ */ foldMap(foldableMaybe)(monoidDrawing);
  var append11 = /* @__PURE__ */ append(semigroupDrawing);
  var eq13 = /* @__PURE__ */ eq(eqPoint2D);
  var compare5 = /* @__PURE__ */ compare(/* @__PURE__ */ ordArray(ordPoint2D));
  var min7 = /* @__PURE__ */ min(ordPoint2D);
  var max7 = /* @__PURE__ */ max(ordPoint2D);
  var append13 = /* @__PURE__ */ append(/* @__PURE__ */ semigroupSet(ordSegment));
  var alt5 = /* @__PURE__ */ alt(altMaybe);
  var unionWith2 = /* @__PURE__ */ unionWith(ordPoint2D);
  var fromFoldable6 = /* @__PURE__ */ fromFoldable(ordPoint2D)(foldableArray);
  var map21 = /* @__PURE__ */ map(functorArray);
  var append23 = /* @__PURE__ */ append(semigroupPoint2D);
  var mempty1 = /* @__PURE__ */ mempty(monoidVertical);
  var mempty22 = /* @__PURE__ */ mempty(monoidHorizontal);
  ...
  var Hover = /* @__PURE__ */ function() {
    function Hover2(value0) {
      this.value0 = value0;
    }
    ;
    Hover2.create = function(value0) {
      return new Hover2(value0);
    };
    return Hover2;
  }();
  var Unhover = /* @__PURE__ */ function() {
    function Unhover2(value0) {
      this.value0 = value0;
    }
    ;
    Unhover2.create = function(value0) {
      return new Unhover2(value0);
    };
    return Unhover2;
  }();
  ...
  var renderClickData = function(v2) {
    var props = function(segment) {
      return [prop3("pointerEvents")("all"), onMouseEnter(pure10(new Hover(segment))), onMouseOut(pure10(new Unhover(segment))), onClick(pure10(new Click(segment)))];
    };
    var drawLine = function(v1) {
      return function(s2) {
        return line3(v1.value0)(v1.value1)(transparent)(props(s2));
      };
    };
    var drawnLines = foldMapWithIndex2(drawLine)(v2.lines);
    var drawCorner = function(point) {
      return function(s2) {
        var $44 = size2(s2) === 1;
        if ($44) {
          return mempty3;
        ...
        ;
        return circle3(point)(1)(NoColor.value)(transparent)(props(s2));
      };
    };
    var drawnCorners = foldMapWithIndex2(drawCorner)(v2.corners);
    var drawCirc = function(circ) {
      return circle3(circ.center)(circ.radius)(transparent)(NoColor.value)(props(singleton4(circ.segment)));
    };
    var drawnCirc = foldMap3(drawCirc)(v2.circles);
    return withoutViewport(append11(drawnLines)(append11(drawnCirc)(drawnCorners)));
  };
  var eqLine = {
    eq: function(v2) {
      return function(v1) {
        return eq13(v2.value0)(v1.value0) && eq13(v2.value1)(v1.value1) || eq13(v2.value0)(v1.value1) && eq13(v2.value1)(v1.value0);
      };
    }
  };
  var ordLine = {
    compare: function(v2) {
      return function(v1) {
        return compare5([min7(v2.value0)(v2.value1), max7(v2.value0)(v2.value1)])([min7(v1.value0)(v1.value1), max7(v1.value0)(v1.value1)]);
      };
    },
    Eq0: function() {
      return eqLine;
  ...
  var unionWith1 = /* @__PURE__ */ unionWith(ordLine);
  var semigroupClickData = {
    append: function(v2) {
      return function(v1) {
        return {
          lines: unionWith1(append13)(v2.lines)(v1.lines),
          circles: alt5(v2.circles)(v1.circles),
          corners: unionWith2(append13)(v2.corners)(v1.corners)
        };
      };
    }
  };
  var monoidClickData = /* @__PURE__ */ function() {
    return {
      mempty: {
        lines: empty2,
        circles: Nothing.value,
        corners: empty2
      },
      Semigroup0: function() {
        return semigroupClickData;
      }
    };
  }();
  var mempty32 = /* @__PURE__ */ mempty(monoidClickData);
  var drawClickData = {
    drawLine: function(m2) {
      return function(p1) {
        return function(p2) {
          if (m2 instanceof Just) {
            return {
              lines: singleton3(new Line(p1, p2))(singleton4(m2.value0)),
              circles: Nothing.value,
              corners: fromFoldable6(map21(function(k) {
                return new Tuple(k, singleton4(m2.value0));
              })([p1, p2]))
            };
          }
          ;
          ...
          ;
          throw new Error("Failed pattern match at Tunic.Clickable (line 63, column 28 - line 70, column 22): " + [m2.constructor.name]);
        };
      };
    },
    drawCirc: function(s2) {
      return function(c2) {
        return function(r2) {
          return {
            lines: empty2,
            ...
            corners: fromFoldable6(map21(function(k) {
              return new Tuple(k, singleton4(s2));
            })([append23(c2)(new Point2D(r2, mempty1)), append23(c2)(new Point2D(-r2, mempty1)), append23(c2)(new Point2D(mempty22, r2)), append23(c2)(new Point2D(mempty22, -r2))]))
          };
        };
      };
    }
  };
  var clickArea = /* @__PURE__ */ renderClickData(/* @__PURE__ */ drawGlyph(foldableNonEmptySet)(monoidClickData)(drawClickData)(fullGlyph));

  // output/Main/index.js
  var append14 = /* @__PURE__ */ append(semigroupDrawing);
  var monoidFn3 = /* @__PURE__ */ monoidFn(monoidDrawing);
  var drawGlyph2 = /* @__PURE__ */ drawGlyph(foldableNonEmptySet)(monoidFn3);
  var mempty4 = /* @__PURE__ */ mempty(monoidPoint2D);
  var drawGlyph1 = /* @__PURE__ */ drawGlyph(foldableSet)(monoidFn3);
  var modify_3 = /* @__PURE__ */ modify_(monadStateHalogenM);
  var eq3 = /* @__PURE__ */ eq(/* @__PURE__ */ eqSet(eqSegment));
  var append15 = /* @__PURE__ */ append(/* @__PURE__ */ semigroupSet(ordSegment));
  var difference3 = /* @__PURE__ */ difference2(ordSegment);
  var initialState = {
    selected: empty3,
    hovered: empty3
  };
  var component = /* @__PURE__ */ function() {
    return mkComponent({
      ...
      render: function(state3) {
        return div_([renderDrawing(append14(group2([])(append14(drawGlyph2(simpleDrawNoLine(new Named("silver")))(fullGlyph)(mempty4))(append14(drawGlyph1(simpleDraw(new Named("black")))(state3.selected)(mempty4))(drawGlyph1(simpleDrawNoLine(new Named("red")))(state3.hovered)(mempty4)))))(group2([])(clickArea)))([height(200)])]);
      },
      "eval": mkEval({
        ...
        handleAction: function(m2) {
          if (m2 instanceof Hover) {
            return modify_3(function(v1) {
              ...
              ;
              $23.hovered = m2.value0;
              return $23;
            });
          }
          ;
          if (m2 instanceof Unhover) {
            return modify_3(function(t2) {
              var $27 = eq3(t2.hovered)(m2.value0);
              if ($27) {
                var $28 = {};
                for (var $29 in t2) {
                  if ({}.hasOwnProperty.call(t2, $29)) {
                    $28[$29] = t2[$29];
                  }
                  ;
                }
          ...
          ;
          if (m2 instanceof Click) {
            return modify_3(function(t2) {
              var $32 = {};
              for (var $33 in t2) {
                if ({}.hasOwnProperty.call(t2, $33)) {
                  $32[$33] = t2[$33];
                }
                ;
              }
              ;
              $32.selected = append15(difference3(t2.selected)(m2.value0))(difference3(m2.value0)(t2.selected));
              return $32;
            });
          }
          ;
          throw new Error("Failed pattern match at Main (line 101, column 60 - line 110, column 8): " + [m2.constructor.name]);
        }
      })
    });
  }();
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind(bindAff)(awaitBody)(/* @__PURE__ */ runUI2(component)(empty3)));
